...
def run_from_cp(pipeline, n_epoch = 1, reduction_factor = 4):
    ...
    for i in range(len(df)):
        ...
        out_dir = os.path.join(work_dir,'longformer','out','sweep','run_cw_pl')
...
run_from_cp(pipeline=3,n_epoch=4)
