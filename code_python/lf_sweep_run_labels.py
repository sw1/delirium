...
def run_from_cp(label, n_epoch = 1, reduction_factor = 4):
    ...
    for i in range(len(df)):
        ...
        out_dir = os.path.join(work_dir,'longformer','out','sweep','run_cw_' + label)
...
run_from_cp(label='only',n_epoch=4)
